...
# ----------- ДОДАНО -----------  
# Кількість елементів у списку і кількість створених об’єктів збігається — обидва 3, але ім’я None змінюється на "Anonymous", 
# тому здається, що «різна кількість імен».
